...
tags=["\"ENG\"", "\"USA\"", "\"FRA\"", "\"RAJ\"", "\"MAN\"", "\"CAN\"", "\"AST\"","\"SAF\"","\"NZL\"", "\"SOV\"", "\"GER\"", "\"ITA\"", "\"HUN\"", "\"ROM\"", "\"BUL\"", "\"JAP\"", "\"MAN\"", "\"FIN\"", "\"SPR\"", "\"NOR\"",  "\"POL\""]
majors=["\"GER\"","\"SOV\"","\"ENG\"","\"JAP\"","\"USA\"","\"ITA\"","\"FRA\""]
alliedminors=["\"RAJ\"", "\"CAN\"", "\"AST\"", "\"SAF\"", "\"NZL\""]
axisminors=["\"HUN\"", "\"ROM\"", "\"BUL\"","\"SPR\"","\"MAN\""]
...
tagic=[ [0]*len(inputtag) for i in range(nautosaves+1)] #monthly IC in cdddolumns
...
for i in range(nautosaves):  
    filename=folderpath+"autosave_"+str(i+1)+".hoi4"
